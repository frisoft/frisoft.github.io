...
var _user$project$Audio$onEnded = function (message) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'ended',
		_elm_lang$core$Json_Decode$succeed(message));
};
var _user$project$Audio$onError = function (message) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'error',
		_elm_lang$core$Json_Decode$succeed(message));
};
var _user$project$Audio$playAudio = F4(
	function (soundUrl, autoPlay, msgEnded, msgError) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src(soundUrl),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: autoPlay ? A2(
						_elm_lang$html$Html$audio,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Audio$onEnded(msgEnded),
									_1: {
										ctor: '::',
										_0: _user$project$Audio$onError(msgError),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Types$DecoratedWord = F6(
	function (a, b, c, d, e, f) {
		return {text: a, soundUrl: b, id: c, playing: d, canPlay: e, mode: f};
	});
var _user$project$Types$PlayAll = F3(
	function (a, b, c) {
		return {playingId: a, startTime: b, time: c};
	});
var _user$project$Types$Model = F5(
	function (a, b, c, d, e) {
		return {words: a, prevWords: b, mode: c, playingWordId: d, playAll: e};
	});
var _user$project$Types$Edit = {ctor: 'Edit'};
var _user$project$Types$Hide = {ctor: 'Hide'};
var _user$project$Types$Show = {ctor: 'Show'};

var _user$project$Msg$PlayAllWords = {ctor: 'PlayAllWords'};
var _user$project$Msg$ShuffledList = function (a) {
	return {ctor: 'ShuffledList', _0: a};
};
var _user$project$Msg$Shuffle = {ctor: 'Shuffle'};
var _user$project$Msg$FocusResult = function (a) {
	return {ctor: 'FocusResult', _0: a};
};
var _user$project$Msg$Save = {ctor: 'Save'};
var _user$project$Msg$Cancel = {ctor: 'Cancel'};
var _user$project$Msg$ShowMode = {ctor: 'ShowMode'};
var _user$project$Msg$HideMode = {ctor: 'HideMode'};
var _user$project$Msg$EditMode = {ctor: 'EditMode'};
var _user$project$Msg$DeleteWord = function (a) {
	return {ctor: 'DeleteWord', _0: a};
};
var _user$project$Msg$AddWord = {ctor: 'AddWord'};
var _user$project$Msg$AudioError = {ctor: 'AudioError'};
var _user$project$Msg$AudioPlayEnded = {ctor: 'AudioPlayEnded'};
var _user$project$Msg$Play = function (a) {
	return {ctor: 'Play', _0: a};
};
var _user$project$Msg$WordSoundUrl = F2(
	function (a, b) {
		return {ctor: 'WordSoundUrl', _0: a, _1: b};
	});
var _user$project$Msg$WordText = F2(
	function (a, b) {
...
var _user$project$Ports$save = _elm_lang$core$Native_Platform.outgoingPort(
	...
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
				return {text: v.text, soundUrl: v.soundUrl, id: v.id};
			});
	});

var _user$project$Utils$wordDomId = function (id) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'word',
...
var _user$project$View$defaultSoundUrl = function (text) {
	var w = A2(_elm_lang$core$Basics_ops['++'], text, '__gb');
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'https://www.oxfordlearnersdictionaries.com/media/english/uk_pron_ogg/',
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$String$left, 1, text),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'/',
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_elm_lang$core$String$left, 3, w),
					A2(
						_elm_lang$core$Basics_ops['++'],
						'/',
						A2(
							_elm_lang$core$Basics_ops['++'],
							A2(_elm_lang$core$String$left, 5, w),
							A2(
								_elm_lang$core$Basics_ops['++'],
								'/',
								A2(_elm_lang$core$Basics_ops['++'], w, '_1.ogg'))))))));
};
var _user$project$View$soundUrlOrDefault = function (word) {
	return (!_elm_lang$core$Native_Utils.eq(word.soundUrl, '')) ? A2(_elm_lang$core$Basics_ops['++'], 'https://www.collinsdictionary.com', word.soundUrl) : _user$project$View$defaultSoundUrl(word.text);
};
var _user$project$View$playButton = function (word) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A4(
				_user$project$Audio$playAudio,
				_user$project$View$soundUrlOrDefault(word),
				word.playing,
				_user$project$Msg$AudioPlayEnded,
				_user$project$Msg$AudioError),
			_1: {
				ctor: '::',
				_0: word.playing ? A2(
						...
						_1: {
							...
							_1: {
								...
								_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('button-play'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('playing'),
						_1: {ctor: '[]'}
					}) : (word.canPlay ? A2(
					_rundis$elm_bootstrap$Bootstrap_Button$button,
					{
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
								{
									...
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Msg$Play(word.id)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('button-play'),
										_1: {ctor: '[]'}
...
var _user$project$View$dictionaryButton = function (word) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Attributes$href(
					A2(_elm_lang$core$Basics_ops['++'], 'http://www.collinsdictionary.com/dictionary/english/', word.text)),
				_1: {
					ctor: '::',
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('dictionary'),
			_1: {ctor: '[]'}
		});
};
var _user$project$View$addNewWord = A2(
	_rundis$elm_bootstrap$Bootstrap_Button$button,
	{
		ctor: '::',
		...
		_1: {
			...
			_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Msg$AddWord),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
...
var _user$project$View$editWord = function (word) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Table$tr,
		{ctor: '[]'},
		{
					...
					_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
						{
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$id(
								_user$project$Utils$wordDomId(word.id)),
							_1: {
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$placeholder('text'),
								_1: {
									ctor: '::',
									_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
										_user$project$Msg$WordText(word.id)),
									_1: {
										ctor: '::',
										_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$defaultValue(word.text),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
							{
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$placeholder('alternative sound URL'),
								_1: {
									ctor: '::',
									_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
										_user$project$Msg$WordSoundUrl(word.id)),
									_1: {
										ctor: '::',
										_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$defaultValue(word.soundUrl),
										_1: {ctor: '[]'}
									}
								}
							}),
				...
				_1: {
										...
										_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Msg$DeleteWord(word.id)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$View$dictionaryButton(word),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$View$playButton(word),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$View$showWordCells = function (word) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Native_Utils.eq(word.mode, _user$project$Types$Show) ? {
			ctor: '::',
			_0: A2(
				_rundis$elm_bootstrap$Bootstrap_Table$td,
				{ctor: '[]'},
...
var _user$project$View$showWord = function (word) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Table$tr,
		{ctor: '[]'},
		_user$project$View$showWordCells(word));
};
var _user$project$View$decoratedWord = F2(
	function (model, word) {
		return {
			text: word.text,
			...
			playing: _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Maybe$Just(word.id),
				model.playingWordId),
			canPlay: _elm_lang$core$Native_Utils.eq(model.playingWordId, _elm_lang$core$Maybe$Nothing),
			mode: model.mode
		};
	});
var _user$project$View$primaryButton = F2(
	function (msg, txt) {
		return A2(
			_rundis$elm_bootstrap$Bootstrap_Button$button,
			{
...
var _user$project$View$edit = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: _rundis$elm_bootstrap$Bootstrap_Table$table(
				{
					options: {
						...
						_1: {
							ctor: '::',
							_0: _rundis$elm_bootstrap$Bootstrap_Table$attr(
								_elm_lang$html$Html_Attributes$class('table-words')),
							_1: {ctor: '[]'}
						}
					},
					thead: A2(
					...
					tbody: A2(
						...
						A2(
							_elm_lang$core$List$map,
							function (w) {
								return _user$project$View$editWord(
									A2(_user$project$View$decoratedWord, model, w));
							},
							model.words))
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('add-new-word-container'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _user$project$View$addNewWord,
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(_user$project$View$primaryButton, _user$project$Msg$Save, 'Save'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(' '),
						_1: {
								...
								_rundis$elm_bootstrap$Bootstrap_Button$button,
								{
									...
									_1: {
										...
										_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Msg$Cancel),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$View$showButtons = function (model) {
	return {
		ctor: '::',
		_0: _elm_lang$core$Native_Utils.eq(model.mode, _user$project$Types$Hide) ? A2(_user$project$View$primaryButton, _user$project$Msg$ShowMode, 'Show words') : A2(_user$project$View$primaryButton, _user$project$Msg$HideMode, 'Hide words'),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html$text(' '),
			_1: {
				ctor: '::',
				_0: A2(_user$project$View$primaryButton, _user$project$Msg$EditMode, 'Edit'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(' '),
					_1: {
						ctor: '::',
						_0: A2(_user$project$View$primaryButton, _user$project$Msg$Shuffle, 'Shuffle'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$View$show = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
				...
				_0: _rundis$elm_bootstrap$Bootstrap_Table$table(
					{
						options: {
							...
							_1: {
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Table$attr(
									_elm_lang$html$Html_Attributes$class('t able-words')),
								_1: {ctor: '[]'}
							}
						},
						thead: A2(
						...
						tbody: A2(
							...
							A2(
								_elm_lang$core$List$map,
								function (w) {
									return _user$project$View$showWord(
										A2(_user$project$View$decoratedWord, model, w));
								},
								model.words))
					}),
			...
			_user$project$View$showButtons(model)));
};
var _user$project$View$header = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Spelling'),
		_1: {ctor: '[]'}
	});
var _user$project$View$page = function (body) {
	return A2(
...
var _user$project$View$view = function (model) {
	...
	switch (_p0.ctor) {
		case 'Show':
			return _user$project$View$page(
				_user$project$View$show(model));
		case 'Hide':
			return _user$project$View$page(
				_user$project$View$show(model));
		default:
			return _user$project$View$page(
				_user$project$View$edit(model));
	}
};

var _user$project$Main$wordsOrDefault = function (words) {
	return _elm_lang$core$List$isEmpty(words) ? {
		ctor: '::',
		_0: A3(_user$project$Types$Word, 'word', '', 1),
		_1: {ctor: '[]'}
	} : words;
};
...
var _user$project$Main$deleteWord = F2(
	function (words, id) {
		return _user$project$Main$sortWords(
			A2(
				_elm_lang$core$List$filter,
				function (w) {
					return !_elm_lang$core$Native_Utils.eq(w.id, id);
				},
				words));
	});
...
var _user$project$Main$addNewWord = function (model) {
	var newId = _user$project$Main$maxWordId(model.words) + 1;
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
			{
				words: A2(
					...
					{
						ctor: '::',
						_0: {text: '', soundUrl: '', id: newId},
						_1: {ctor: '[]'}
					})
			}),
		_1: A2(
			_elm_lang$core$Task$attempt,
			_user$project$Msg$FocusResult,
			_elm_lang$dom$Dom$focus(
				_user$project$Utils$wordDomId(newId)))
	};
};
var _user$project$Main$getWordById = F2(
	function (words, id) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
...
var _user$project$Main$doNothing = function (model) {
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};
var _user$project$Main$playAllNewTime = F2(
	function (playAll, newTime) {
		return _elm_lang$core$Native_Utils.update(
			playAll,
			{time: newTime});
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'WordText':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							words: A3(_user$project$Main$updateText, _p1._0, _p1._1, model.words)
						}),
			...
			case 'WordSoundUrl':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							words: A3(_user$project$Main$updateSoundUrl, _p1._0, _p1._1, model.words)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Play':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							playingWordId: _elm_lang$core$Maybe$Just(_p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AudioPlayEnded':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{playingWordId: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AudioError':
				return {
			...
			case 'AddWord':
				return _user$project$Main$addNewWord(model);
			case 'DeleteWord':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							words: A2(_user$project$Main$deleteWord, model.words, _p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'EditMode':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{mode: _user$project$Types$Edit}),
					_1: A2(
						_elm_lang$core$Task$attempt,
						_user$project$Msg$FocusResult,
						_elm_lang$dom$Dom$focus('new-word'))
				};
			case 'HideMode':
				return {
					ctor: '_Tuple2',
			...
			case 'Cancel':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{words: model.prevWords, mode: _user$project$Types$Show}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Save':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							words: _user$project$Main$deleteEmptyWords(model.words),
							mode: _user$project$Types$Show
						}),
					_1: _user$project$Ports$save(model.words)
				};
			case 'FocusResult':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Shuffle':
				return {
					...
					_1: A2(
						_elm_lang$core$Random$generate,
						_user$project$Msg$ShuffledList,
						_elm_community$random_extra$Random_List$shuffle(model.words))
				};
			case 'ShuffledList':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{words: _p1._0, mode: _user$project$Types$Hide}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return _user$project$Main$doNothing(model);
		}
	});
...
var _user$project$Main$init = function (flags) {
	var words = _user$project$Main$wordsOrDefault(flags.words);
	return {
		ctor: '_Tuple2',
		_0: A5(
			...
			words,
			words,
			_user$project$Types$Show,
			_elm_lang$core$Maybe$Nothing,
			A3(_user$project$Types$PlayAll, 0, 0, 0)),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
